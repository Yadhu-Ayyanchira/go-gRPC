...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xd8\x02\n" +
	"\fGreetService\x12A\n" +
	"\bSayHello\x12\x17.greet_service.NoParams\x1a\x1c.greet_service.HelloResponse\x12R\n" +
	"\x17SayHelloServerStreaming\x12\x17.greet_service.NameList\x1a\x1c.greet_service.HelloResponse0\x01\x12P\n" +
	"\x17SayHelloClientStreaming\x12\x17.greet_service.NameList\x1a\x1a.greet_service.MessageList(\x01\x12_\n" +
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	3, // 2: greet_service.GreetService.SayHelloClientStreaming:input_type -> greet_service.NameList
